        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../images/users/<?php echo isset($_SESSION['avatar'])?$_SESSION['avatar']:'default.jpg'; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"> <?php echo "HI, "; echo isset($_SESSION['name'])?$_SESSION['name']:'No login'; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../images/user/<?php echo isset($_SESSION['avatar'])?$_SESSION['avatar']:'default.jpg'; ?>" class="img-circle" alt="User Image">
