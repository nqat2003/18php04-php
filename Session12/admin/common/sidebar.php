<section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="../images/users/<?php echo isset($_SESSION['avatar'])?$_SESSION['avatar']:'default.jpg'; ?>" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?action=add_news"><i class="fa fa-plus"></i> Add News</a></li>
            <li><a href="index.php?action=list_news"><i class="fa fa-th-list"></i> List News</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
