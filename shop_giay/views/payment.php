							...
							<div class="tab1">
								<div class="pay_info">
									<div class="vertical_post check_box_agile">
										<form action="index.php?action=endpay" class="creditly-card-form submit" method="POST">
											<div class="controls">
												<label class="control-label">Name </label>
												<input class="billing-address-name form-control" type="text" name="name" value="<?php echo $name; ?>">
											</div>
											<div class="controls">
												<label class="control-label">Phone </label>
												<input class="billing-address-name form-control" type="text" name="phone" value="<?php echo $phone; ?>">
											</div>
											<div class="controls">
												<label class="control-label">Address </label>
												<input class="billing-address-name form-control" type="text" name="addr" value="<?php echo $addr; ?>">
											</div>
											<div class="controls">
												<label class="control-label">City </label>
												<input class="billing-address-name form-control" type="text" name="city" value="<?php echo $city; ?>">
											</div>
											<label>Choose type of COD:</label>
											<div class="form-check">
												<div class="checkbox">
													<div class="check_box_one cashon_delivery">
														<label class="anim">
															<input type="checkbox" class="checkbox">
															<span> Free ship (delivery after 7-10 days)</span> 
														</label>
													</div>
											...
											<div class="form-check">
												<div class="checkbox">
													<div class="check_box_one cashon_delivery">
														<label class="anim">
															<input type="checkbox" class="checkbox">
															<span>Fast ship (delivery after 3-5 days - 30$)</span> 
														</label>
													</div>
											...
											<div class="controls">
												<input class="billing-address-name form-control" type="hidden" name="total" value="<?php echo $city; ?>">
											</div>
											<p><b>Total money: <span>$<?php echo $_SESSION['sum']; ?></span></b></p>
											<button type="submit" class="submit" name="submit"><span>Make a payment </span></button>
											</form>
									</div>
										...
										<form action="#" method="post">
											...
											<div class="swit-radio">
												<div class="check_box_one">
													<div class="radio_one"> <label><input type="radio" name="radio" checked=""><i></i>Sacombank</label> </div>
												</div>
												<div class="check_box_one">
